...
- looker_embed_generator.py does us urllib.parse but does not open any URLs or implement any blacklist or blocking of URLs.  As such version of python3 less than 3.11 will work without issue [CVE-2023-24329](https://nvd.nist.gov/vuln/detail/CVE-2023-24329) being of concern.
