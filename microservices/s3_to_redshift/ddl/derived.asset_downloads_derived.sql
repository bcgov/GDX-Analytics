...
( 
  "asset_url" VARCHAR(4095) ENCODE ZSTD,
  ...
  "asset_file" VARCHAR(4095) ENCODE ZSTD,
  "asset_ext" VARCHAR(255) ENCODE ZSTD,
  "user_agent_http_request_header" VARCHAR(4095) ENCODE ZSTD,
  "request_string" VARCHAR(4095) ENCODE ZSTD,
  "asset_host" VARCHAR(255) ENCODE ZSTD,
  "asset_source" VARCHAR(255) ENCODE ZSTD,
